...
<html>
	<head>
		...
		<title><s:text name="contact.titre.search"/></title>
	</head>
	<body>
		<!-- DIV PAGE -->
		<div id="page">
			<h1><s:text name="contact.titre.search"/></h1>
			
			<!-- DIV TOOL -->
			<div id="tools">
			
				<div id="addContact">
					<s:url id="url" action="listContact" />
					<s:a href="%{url}"><s:text name="contact.retour_list"/></s:a>
				</div>
			
				<div id="searchForm">
					<s:form action="searchContact" method="GET">
						<s:text name="contact.rechercher"/>
