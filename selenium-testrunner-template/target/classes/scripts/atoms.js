...
bot.Keyboard.prototype.fireKeyEvent_ = function(a, b) {
  ...
  bot.events.fire(this.element_, a, c)
};
...
bot.Mouse.prototype.releaseButton = function() {
  ...
  this.buttonPressed_ == bot.Mouse.Button.LEFT && this.element_ == this.elementPressed_ ? this.clickElement_() : this.buttonPressed_ == bot.Mouse.Button.RIGHT && this.fireEvent_(goog.events.EventType.CONTEXTMENU);
  this.elementPressed_ = this.buttonPressed_ = null
};
bot.Mouse.prototype.clickElement_ = function() {
  ...
  var d = (c = bot.action.isSelectable(this.element_)) && bot.action.isSelected(this.element_);
  if(goog.userAgent.IE && b) {
    b.click()
  }else {
    if(this.fireEvent_(goog.events.EventType.CLICK) && (a && bot.Mouse.isFollowingHref_(a) && bot.Mouse.followHref_(a), c && this.isInteractable_(this.element_))) {
      if(d) {
...
bot.Mouse.isFollowingHref_ = function(a) {
  if(!a || !a.href) {
    return!1
  }
  ...
  var b = goog.dom.getWindow(goog.dom.getOwnerDocument(a)), c = b.location.href, b = bot.Mouse.resolveUrl_(b.location, a.href), c = c.split("#")[0] === b.split("#")[0];
  return!a.target && !c
};
...
bot.action = {};
bot.action.isInteractable_ = function(a, b) {
  var c = bot.dom.isShown(a, !0), d = c && bot.dom.isEnabled(a);
  if(b && !c) {
...
bot.action.setSelected = function(a, b) {
  bot.action.isInteractable_(a, !0);
  if(bot.dom.isElement(a, goog.dom.TagName.INPUT)) {
...
bot.action.click = function(a, b) {
  bot.action.click_(a, bot.Mouse.Button.LEFT, b)
};
bot.action.rightClick = function(a, b) {
  bot.action.click_(a, bot.Mouse.Button.RIGHT, b)
};
bot.action.click_ = function(a, b, c) {
  if(!bot.dom.isShown(a, !0)) {
    throw new bot.Error(bot.ErrorCode.ELEMENT_NOT_VISIBLE, "Element is not currently visible and may not be manipulated");
  }
  var d = bot.dom.getActiveElement(a), e = goog.dom.getOwnerDocument(a);
  goog.style.scrollIntoContainerView(a, goog.userAgent.WEBKIT ? e.body : e.documentElement);
  c || (c = goog.style.getSize(a), c = new goog.math.Coordinate(c.width / 2, c.height / 2));
  e = new bot.Mouse(bot.action.isInteractable_);
  e.move(a, c);
  e.pressButton(b) && bot.action.isInteractable_(a) && bot.action.focusOnElement(a, d);
  e.releaseButton()
};
bot.action.drag = function(a, b, c, d) {
  bot.action.isInteractable_(a, !0);
  var e = new bot.Mouse(bot.action.isInteractable_);
...
bot.html5.isSupported = function(a, b) {
  ...
  switch(a) {
    ...
    case bot.html5.API.SESSION_STORAGE:
      return goog.isDefAndNotNull(c.sessionStorage);
    default:
...
bot.storage.database.openOrCreate = function(a, b, c, d, e) {
  ...
  d = d || 5242880;
  e = e || bot.getWindow();
  if(bot.html5.isSupported(bot.html5.API.DATABASE, e)) {
    a = e.openDatabase(a, b, c, d)
  }else {
    throw new bot.Error(bot.ErrorCode.UNKNOWN_ERROR, "window.openDatabase undefined");
  }
  return a
};
bot.storage.database.executeSql = function(a, b, c, d, e, f, g) {
  ...
  var i;
  try {
    i = bot.storage.database.openOrCreate(a)
  }catch(j) {
    throw new bot.Error(bot.ErrorCode.UNKNOWN_ERROR, j.message);
  }
  i.transaction(function(a) {
    a.executeSql(b, c, h, g)
  }, e, f)
};
